      ...
      if(x != ""){
        for (var j=0; j<listGame.length; j++) {
            if (listGame[j].title.toUpperCase().indexOf(x.toUpperCase()) >= 0) {
                ...
                var img = "";
                if(item.domain == 1){
                    img = `https://nguyenvietdu3007.github.io/games/file/${item.slug}/logo.png`;
                } else if(item.domain == 2) {
                    img = `https://nguyenvietdu3007.github.io/games/rungame/${item.slug}/logo.png`;
                  ...
                  img = `https://nguyenvietdu3007.github.io/games/newgame/${item.slug}/logo.png`;
